namespace benz_st
{
    partial class Form3
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.appData = new benz_st.AppData();
            ...
            this.расчетПродажиСуммыBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.расчет_продажи_суммыTableAdapter = new benz_st.AppDataTableAdapters.Расчет_продажи_суммыTableAdapter();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.расчетПродажиСуммыBindingSource)).BeginInit();
            this.SuspendLayout();
            // 
            // appData
            // 
            ...
            this.toolStripContainer1.TopToolStripPanel.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.расчетПродажиСуммыBindingSource, "Название фирмы", true));
            // 
            // расчетПродажиСуммыBindingSource
            // 
            this.расчетПродажиСуммыBindingSource.DataMember = "Расчет продажи суммы";
            this.расчетПродажиСуммыBindingSource.DataSource = this.appData;
            // 
            // расчет_продажи_суммыTableAdapter
            // 
            this.расчет_продажи_суммыTableAdapter.ClearBeforeFill = true;
            // 
            // Form3
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.расчетПродажиСуммыBindingSource)).EndInit();
        ...
        private System.Windows.Forms.BindingSource расчетПродажиСуммыBindingSource;
        private AppDataTableAdapters.Расчет_продажи_суммыTableAdapter расчет_продажи_суммыTableAdapter;
    }
}